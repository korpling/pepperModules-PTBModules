...
public static final String PREFIX="ptb.Exporter.";
	...
	/**
	 * Name of namespace for nodes to be exported and their annotations, e.g. 'ptb'.
	 */
	...
	/**
	 * Namespace for edge annotations (represented within a node label after a separator), e.g. 'ptb'.
	 */
