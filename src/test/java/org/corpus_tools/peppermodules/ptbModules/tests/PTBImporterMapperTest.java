...
public class PTBImporterMapperTest {
	...
	/**
	 * Test for the standard PTB dialect with relation labels, node labels and
	 * POS at left bracket and terminals at right bracket
	 * 
	 * @throws IOException
	 */
	@Test
	public void testStandardDialect() throws IOException {
		...
		// salt2dot.salt2Dot(getFixture().getDocument().getDocumentGraph(),
		// URI.createFileURI("D:/dot_out.dot"));
	...
	/**
	 * Test for atis style slash dialect with no relation labels, node labels
	 * and terminals and POS separated by slash and not surrounded by brackets
	 * 
	 * @throws IOException
	 */
	@Test
	...
	/**
	 * Test for the standard PTB dialect with no relation labels, one sentence
	 * per line, node labels and POS at left bracket and terminals at right
	 * bracket
	 * 
	 * @throws IOException
	 */
	...
	/**
	 * Checks that even output from Stanford parser is parsable. Stanford
	 * produces partly entire sentences in one line.
	 * 
	 * @throws IOException
	 */
	@Test
	public void test_stanford_output() throws IOException {
		// String input=
		// "# D:\\stanford-tregex-2013-06-20\\mag-editorial\\c_m_ed_bjr_001.txt.prd_705_705_18_694:\n"+
